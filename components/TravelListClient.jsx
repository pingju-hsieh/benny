...
export default function TravelListClient({ posts }) {
          ...
          {filtered.map((post) => {
            ...
            return (
              <Link
                ...
                className="rounded-2xl overflow-hidden shadow-lg bg-white hover:shadow-2xl transition cursor-pointer group"
              >
